...
-   **Hypothesis** \refstepcounter{mhyp}\themhyp \label{hyp-M1}: The scope of the changes in natural capital is influencing the values of natural capital.

-   **Hypothesis** \refstepcounter{mhyp}\themhyp \label{hyp-M2}: The distributional consequences of the payment vehicle have a significant impact on the elicited values of natural capital.

-   **Hypothesis**\refstepcounter{mhyp}\themhyp \label{hyp-M3}: Derived natural capital values depend more on the relative than the absolute attribute levels, when comparing two different vectors of attribute levels.

-   **Hypothesis** \refstepcounter{mhyp}\themhyp \label{hyp-M4}: If the duration of the payment period increases, respondents are less likely to vote in favor of increases in natural capital.

-   **Hypothesis** \refstepcounter{mhyp}\themhyp \label{hyp-M5}: The order of the alternatives and the order of the attributes do not affect choice patterns and willingness to pay values.
...
-   **Hypothesis** \refstepcounter{thyp}\thethyp \label{hyp-rulebased}: Provision of hints for rule-based calculations of past trips compared to no hints:
...
-   **Hypothesis** \refstepcounter{thyp}\thethyp \label{hyp-T4}: Provision of the timeline graph in the visit number elicitation question compared to no timeline graph:
...
-   **Hypothesis** \refstepcounter{thyp}\thethyp \label{hyp-T5}: Provision of feedback on how the reported number of trips translates to average frequency of visits before asking the respondents
